    ...
    <div class="setup-card">
        ...
        <form id="setupForm" class="space-y-4">
            ...
            <div>
                ...
                <input type="url" id="site_base_url" name="site_base_url"
                    value="https://sitio.com" class="form-input"
                    placeholder="https://sitio.com">
                <p class="help-text">Ej: <code class="text-indigo-400">https://es.3hentai.net</code> — <strong>NO</strong> es para crear cuenta, solo la dirección del sitio</p>
            </div>

            <div class="grid grid-cols-2 gap-3">
                <div>
                    <label for="site_view_path">Ruta vista individual</label>
                    <input type="text" id="site_view_path" name="site_view_path"
                        value="/d" class="form-input" placeholder="/view">
                    <p class="help-text">Ej: <code class="text-indigo-400">/d</code> para 3hentai, <code class="text-indigo-400">/view</code> para otros</p>
                </div>
                <div>
                    <label for="site_batch_path">Ruta búsqueda/batch</label>
                    <input type="text" id="site_batch_path" name="site_batch_path"
                        value="/search" class="form-input" placeholder="/parody">
                    <p class="help-text">Ej: <code class="text-indigo-400">/search</code> para 3hentai, <code class="text-indigo-400">/parody</code> para otros</p>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" id="download_path" name="download_path"
                    ...
                    placeholder="<?php echo __DIR__; ?>/descargas">
                <p class="help-text">Ruta absoluta o relativa. Si se deja vacío, usa el valor por defecto: <code class="text-indigo-400"><?php echo __DIR__; ?>/descargas</code></p>
            </div>

            <!-- ── Sección: Anti-Ban (opcional) ── -->
            <div class="border-b border-gray-800 pb-2 mb-2">
